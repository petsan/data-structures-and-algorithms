...
// $('button').text()).toStrictEqual('submit')
...
//    on the fifteenth day of June in the seventeenth year of our reign (i.e. 1215: the new
//    regnal year began on 28 May).')).toStrictEqual(['Given', 'Runnymede', 'Windsor', 'Staines', 'June', 'May']);
